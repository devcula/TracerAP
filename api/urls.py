...
urlpatterns = [
    ...
    path('GetPatientData_Village/', views.GetPatientData_Village,
         name="GetPatientData_Village"),

    # AUTH URLS
    # ULTRA EXCLUSIVE DEV API
    path('login-browse/', include('rest_framework.urls')),
